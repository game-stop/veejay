...
my @common = (
    ...
    ["stream.buffer.length", "VIMS_STREAM_SET_BUFFER_LENGTH"],
    ["stream.buffer.forward", "VIMS_STREAM_BUFFER_FORWARD"],
    ["stream.buffer.backward", "VIMS_STREAM_BUFFER_BACKWARD"],
    ["stream.buffer.reverse", "VIMS_STREAM_BUFFER_BACKWARD"],
    ["stream.buffer.stop", "VIMS_STREAM_BUFFER_STOP"],
    ["stream.buffer.speed", "VIMS_STREAM_BUFFER_SET_SPEED"],
    ["stream.buffer.slow", "VIMS_STREAM_BUFFER_SET_SLOW"],
    ["stream.buffer.frame", "VIMS_STREAM_BUFFER_SET_FRAME"],
    ["stream.buffer.skip.frame", "VIMS_STREAM_BUFFER_SKIP_FRAME"],
    ["stream.buffer.skip.second", "VIMS_STREAM_BUFFER_SKIP_SECOND"],
    ["stream.buffer.prev.second", "VIMS_STREAM_BUFFER_PREV_SECOND"],
    ["buffer.length", "VIMS_STREAM_SET_BUFFER_LENGTH"],
    ["buffer.forward", "VIMS_STREAM_BUFFER_FORWARD"],
    ["buffer.reverse", "VIMS_STREAM_BUFFER_BACKWARD"],
    ["buffer.stop", "VIMS_STREAM_BUFFER_STOP"],
    ["buffer.speed", "VIMS_STREAM_BUFFER_SET_SPEED"],
    ["buffer.slow", "VIMS_STREAM_BUFFER_SET_SLOW"],
    ["buffer.frame", "VIMS_STREAM_BUFFER_SET_FRAME"],
    ...
    ["sync.wav.profile.set", "VIMS_AUDIO_SYNC_WAV_PROFILE_SET"],
    ["sync.wav.profile.clear", "VIMS_AUDIO_SYNC_WAV_PROFILE_CLEAR"],
    ["wav.profile.set", "VIMS_AUDIO_SYNC_WAV_PROFILE_SET"],
    ["wav.profile.clear", "VIMS_AUDIO_SYNC_WAV_PROFILE_CLEAR"],
    ["sample.sync.set", "VIMS_SAMPLE_AUDIO_SYNC_SET"],
    ["sample.sync.clear", "VIMS_SAMPLE_AUDIO_SYNC_CLEAR"],
    ["sample.sync.rearm", "VIMS_SAMPLE_AUDIO_SYNC_REARM"],
