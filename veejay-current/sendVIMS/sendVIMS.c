...
#define SENDVIMS_STATUS_TOKENS       163  /* lock-step with vims.h / VIMS_STATUS_TOKENS */
...
#if SENDVIMS_STATUS_TOKENS != 163
#error "SENDVIMS_STATUS_TOKENS must be 163 for veejay status fields 0..163"
#endif
