...
extern void veejay_print_backtrace(void);
extern void veejay_print_banner(void);
extern void veejay_strrep(char *s, char delim, char tok);
extern void veejay_msg(int type, const char format[], ...);
extern int veejay_is_colored(void);
extern void veejay_set_debug_level(int level);
extern int veejay_get_debug_level(void);
extern void veejay_set_colors(int level);
extern void veejay_silent(void);
extern int veejay_is_silent(void);
...
extern char* veejay_msg_ringfetch(void);
extern int veejay_log_to_ringbuffer(void);
extern void veejay_toggle_osl(void);
