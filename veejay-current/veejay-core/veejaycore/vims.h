...
#define VJ_SEQUENCE_STATUS_TOKENS         7

#define VJ_STATUS_EXPECTED_TOKENS \
    (VJ_STATUS_BASE_TOKENS + VJ_AUDIO_STATUS_TOKENS + VJ_CHAIN_ENTRY_STATUS_TOKENS + VJ_SEQUENCE_STATUS_TOKENS)
...
#if VIMS_STATUS_TOKENS != 118
#error "VIMS_STATUS_TOKENS must be 118 for status fields 0..117"
#endif
