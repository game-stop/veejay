...
#define VJ_AUDIO_MIXER_STATUS_TOKENS      2

#define VJ_STATUS_EXPECTED_TOKENS \
    (VJ_STATUS_BASE_TOKENS + VJ_AUDIO_STATUS_TOKENS + VJ_CHAIN_ENTRY_STATUS_TOKENS + VJ_SEQUENCE_STATUS_TOKENS + VJ_AUDIO_BEAT_CONFIG_STATUS_TOKENS + VJ_AUDIO_MIXER_STATUS_TOKENS)
...
#define VJ_STATUS_AUDIO_MIX_CROSSFADE            132
#define VJ_STATUS_AUDIO_MIXER_LAST               133

#if VIMS_STATUS_TOKENS != 133
#error "VIMS_STATUS_TOKENS must be 133 for status fields 0..132"
#endif
