...
#define VJ_STATUS_EXPECTED_TOKENS \
    (VJ_STATUS_BASE_TOKENS + VJ_AUDIO_STATUS_TOKENS + VJ_CHAIN_ENTRY_STATUS_TOKENS + VJ_SEQUENCE_STATUS_TOKENS + VJ_AUDIO_BEAT_CONFIG_STATUS_TOKENS)
...
#if VIMS_STATUS_TOKENS != 131
#error "VIMS_STATUS_TOKENS must be 131 for status fields 0..130"
#endif
