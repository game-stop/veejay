...
/* Name of package */
#define PACKAGE "lvdcrop-plugin"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "veejay-users@lists.sourceforge.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "lvdcrop-plugin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "lvdcrop-plugin 0.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lvdcrop-plugin"
