...
/* Name of package */
#define PACKAGE "lvdasciiart-plugin"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "veejay-users@lists.sourceforge.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "lvdasciiart-plugin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "lvdasciiart-plugin 0.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lvdasciiart-plugin"
...
/* Building Livido AsciiArt filter */
#define VEEJAYUTIL 1
