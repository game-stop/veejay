...
livido_process_f		process_instance( livido_port_t *my_instance, double timecode )
{
	...
	int		color_mode = lvd_extract_param_index( my_instance,"in_parameters", 5 );
	
	snprintf(cmd,sizeof(cmd),"-rodilius %d,%d,%d,%d,%d,%d",
			amplitude,thickness,sharpness,nb_orientations,offset,color_mode);
