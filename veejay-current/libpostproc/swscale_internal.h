...
#define MSG_WARN(args...) veejay_msg(VEEJAY_MSG_WARNING,##args )
#define MSG_FATAL(args...) veejay_msg(VEEJAY_MSG_ERROR, ##args )
#define MSG_ERR(args...) veejay_msg(VEEJAY_MSG_ERROR,##args )
#define MSG_V(args...) veejay_msg(VEEJAY_MSG_DEBUG,##args )
#define MSG_DBG2(args...) veejay_msg(VEEJAY_MSG_DEBUG, ##args )
#define MSG_INFO(args...) veejay_msg(VEEJAY_MSG_INFO, ##args )
