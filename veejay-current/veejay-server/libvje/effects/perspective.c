...
vj_effect *perspective_init(int width, int height)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ve->num_params,
        VJ_BEAT_DRIFT,    VJ_BEAT_F_PHRASE_ONLY | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_INVERTED | VJ_BEAT_F_NO_ZERO_CROSS, 6,                  44,                 4,  14, 3200, 8600, 2400, 18,
        VJ_BEAT_DRIFT,    VJ_BEAT_F_PHRASE_ONLY | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_INVERTED | VJ_BEAT_F_NO_ZERO_CROSS, 6,                  44,                 4,  14, 3200, 8600, 2400, 18,
        VJ_BEAT_DRIFT,    VJ_BEAT_F_PHRASE_ONLY | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS,                      56,                 94,                 4,  14, 3200, 8600, 2400, 18,
        VJ_BEAT_DRIFT,    VJ_BEAT_F_PHRASE_ONLY | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_INVERTED | VJ_BEAT_F_NO_ZERO_CROSS, 6,                  44,                 4,  14, 3200, 8600, 2400, 18,
        VJ_BEAT_DRIFT,    VJ_BEAT_F_PHRASE_ONLY | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS,                      56,                 94,                 4,  14, 3200, 8600, 2400, 18,
        VJ_BEAT_DRIFT,    VJ_BEAT_F_PHRASE_ONLY | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS,                      56,                 94,                 4,  14, 3200, 8600, 2400, 18,
        VJ_BEAT_DRIFT,    VJ_BEAT_F_PHRASE_ONLY | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_INVERTED | VJ_BEAT_F_NO_ZERO_CROSS, 6,                  44,                 4,  14, 3200, 8600, 2400, 18,
