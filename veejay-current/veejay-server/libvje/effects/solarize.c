...
vj_effect *solarize_init(int w, int h)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ve->num_params,
        VJ_BEAT_CONTRAST,      VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 8,                  220,                12, 46, 1000, 3600, 0,    72,
        VJ_BEAT_SELECTOR,      VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL,        VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0,  0,    0,    0,    0,    -1000,
        VJ_BEAT_WINDOW_RADIUS, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 4,                  112,                12, 46, 1000, 3600, 0,    68,
        VJ_BEAT_CONTRAST,      VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 140,                1000,               14, 54,  800, 3000, 0,    82,
        VJ_BEAT_COLOR_AMOUNT,  VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 180,                1000,               12, 46, 1000, 3600, 0,    70,
        VJ_BEAT_INTENSITY,     VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 120,                1000,               16, 62,  700, 2800, 0,    92,
        VJ_BEAT_COLOR_PHASE,   VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 120,                1000,               16, 62,  700, 2800, 0,    88
    );
