...
;
    {
        const vj_beat_param_hint_t beat_hints[] = {
            VJ_BEAT_HINT_V2(VJ_BEAT_WINDOW_RADIUS, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_VELOCITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 1, 8, 72, 94, 16, 520, 0, 1, 120, VJ_BEAT_COST_MODERATE, 80, 1, 0, VJ_BEAT_GROUP_ASCENDING, 1),
            VJ_BEAT_HINT_V2(VJ_BEAT_WINDOW_RADIUS, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_VELOCITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 4, 16, 86, 100, 16, 520, 0, 1, 120, VJ_BEAT_COST_MODERATE, 86, 1, 1, VJ_BEAT_GROUP_ASCENDING, 1),
            VJ_BEAT_HINT_V2(VJ_BEAT_DETAIL, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_HIGH_ACTIVITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_SMOOTHSTEP, 1, 8, 62, 84, 80, 720, 0, 1, 160, VJ_BEAT_COST_MODERATE, 68, 0, 0, VJ_BEAT_GROUP_NONE, 0),
...
#pragma omp sections
        {
#pragma omp section
            { veejay_memcpy(dstY, srcY, len); }
#pragma omp section
            { veejay_memcpy(dstU, srcU, len); }
#pragma omp section
            { veejay_memcpy(dstV, srcV, len); }
        }
    }
    else {
#pragma omp sections
