...
vj_effect *kineticdisplay_init(int w, int h)
{
...

    {
        const vj_beat_param_hint_t beat_hints[] = {
            VJ_BEAT_HINT_V2(VJ_BEAT_INTENSITY, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_ACTIVITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_SMOOTHSTEP, 15, 100, 84, 100, 20, 620, 0, 1, 0, VJ_BEAT_COST_CHEAP, 92, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_GRID_SIZE, VJ_BEAT_F_DISCRETE | VJ_BEAT_F_NO_ZERO_CROSS | VJ_BEAT_F_REBUILDS_STATE, VJ_BEAT_SRC_SCRATCH_VELOCITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_NEGATIVE, VJ_BEAT_CURVE_EASE_OUT, 6, 28, 72, 96, 10, 620, 0, 1, 650, VJ_BEAT_COST_MODERATE, 72, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_MOTION_REACT, VJ_BEAT_F_CONTINUOUS, VJ_BEAT_SRC_SCRATCH_ACTIVITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_NEGATIVE, VJ_BEAT_CURVE_EASE_OUT, 40, 190, 82, 100, 10, 480, 0, 1, 0, VJ_BEAT_COST_CHEAP, 90, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_TURBULENCE, VJ_BEAT_F_CONTINUOUS, VJ_BEAT_SRC_SCRATCH_BURST, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_PUNCH, 0, 100, 84, 100, 0, 420, 0, 1, 0, VJ_BEAT_COST_CHEAP, 88, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_SPEED, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_VELOCITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 15, 100, 92, 100, 8, 400, 0, 1, 0, VJ_BEAT_COST_CHEAP, 100, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_INERTIA, VJ_BEAT_F_CONTINUOUS, VJ_BEAT_SRC_SCRATCH_ACTIVITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_NEGATIVE, VJ_BEAT_CURVE_EASE_OUT, 0, 65, 76, 100, 20, 720, 0, 1, 0, VJ_BEAT_COST_CHEAP, 82, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_MEMORY, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_ENVELOPE, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LOG, 20, 95, 70, 96, 80, 1500, 0, 1, 0, VJ_BEAT_COST_CHEAP, 76, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_GLOW, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_HIGH_ONSET, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_PUNCH, 80, 220, 82, 100, 0, 520, 0, 1, 0, VJ_BEAT_COST_CHEAP, 86, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_CONTRAST, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_ACTIVITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_SMOOTHSTEP, 70, 220, 78, 100, 20, 680, 0, 1, 0, VJ_BEAT_COST_CHEAP, 84, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_SELECTOR, VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL, VJ_BEAT_SRC_NONE, VJ_BEAT_OP_NONE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LINEAR, VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0, 0, 0, 0, 0, 0, 0, VJ_BEAT_COST_STRUCTURAL, -1000, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_MOTION_REACT, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_BURST, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_PUNCH, 20, 100, 92, 100, 0, 380, 0, 1, 0, VJ_BEAT_COST_CHEAP, 98, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_RESET, VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL | VJ_BEAT_F_REBUILDS_STATE, VJ_BEAT_SRC_NONE, VJ_BEAT_OP_NONE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LINEAR, VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0, 0, 0, 0, 0, 0, 0, VJ_BEAT_COST_STRUCTURAL, -1000, 0, 0, VJ_BEAT_GROUP_NONE, 0)
        };
        ...
        for(int cx = 0; cx < cols; cx++) {
            ...
            for(int y = y0; y < y1; y++) {
                ...
                for(int x = x0; x < x1; x++) {
                    ...
                    sum_u += U[p];
                    sum_v += V[p];
                    sum_m += kd_absi(yy - (int)k->prev_y[p]);
                    count++;
                }
            }
            ...
            if(kd_absi(target - old_target) > 6) {
            ...
            const int boost = (motion * motion_react) / 255;
            int local_speed = speed + ((100 - speed) * boost) / 100;
            int step = 2 + (local_speed * 52) / 100;

            if(target < value) {
                const int damp = 20 + (100 - persistence);
                step = (step * damp) / 120;
                ...
                for(int x = x0; x < x1; x++) {
                    ...
                    switch(mode) {
                        ...
                        case KD_MODE_SPLIT_FLAP: {
                            ...
                            if(ly < ch / 2)
                                fy = kd_clampi(fy + 16, 0, 255);
                            else
                                fy = kd_clampi(fy - 18, 0, 255);

                            if(ly == ch / 2 || ly == ch / 2 - 1)
                                fy = dark;

                            if(phase > 24) {
                                const int flap = (phase * ch) >> 8;
                                if(kd_absi(ly - flap) <= 1)
                                    fy = 245;
                            }
                        ...
                        case KD_MODE_RELAY_LAMPS: {
                            ...
                            if(r2 < r2max) {
                                const int fall = r2max - r2;
                                fy = dark + (lit * fall) / r2max;
                                if(r2 < (r2max >> 3))
                                    fy = kd_clampi(fy + 28, 0, 255);
                                fu = fx_u_lit;
                                fv = fx_v_lit;
                            }
                            break;
                        ...
                        case KD_MODE_AIRPORT_BOARD: {
                            ...
                            if(((ly / band) & 1) == 0)
                                fy = kd_clampi(fy + 12, 0, 255);

                            if(phase > 96 && ((ly + frame_no + rnd) & 7) == 0)
                                fy = dark;
                        ...
                        case KD_MODE_MAGNETIC: {
                            ...
                            if(kd_absi((lx * ch) - (ly * cw)) < cw + ch)
                                fy = kd_clampi(fy + 22, 0, 255);
                        ...
                        case KD_MODE_WAVE_FLIP: {
                            const int wave = ((cx * 13 + cy * 7 + frame_no * 3) & 63);
                            const int band = kd_absi(((lx + ly + wave) & 31) - 16);
                        ...
                        default: {
                            int local = lit;
                            const int hsh = kd_hash_cell(cx, cy, frame_no + lx + ly);
