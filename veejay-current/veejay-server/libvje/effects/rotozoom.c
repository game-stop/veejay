...
vj_effect *rotozoom_init(int width, int height)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ...
        VJ_BEAT_WARP,             VJ_BEAT_F_CONTINUOUS,                                               -320,               720,                12, 46, 1000, 3600, 0,    78,
        VJ_BEAT_SELECTOR,         VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL,                            VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0,  0,    0,    0,    0,    -1000,
        VJ_BEAT_SPEED,            VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_INVERTED | VJ_BEAT_F_NO_ZERO_CROSS, 36,                 900,                12, 46, 1000, 3600, 0,    74,
        ...
        VJ_BEAT_SPEED,            VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                     120,                1000,               16, 62,  700, 2800, 0,    90
    );
