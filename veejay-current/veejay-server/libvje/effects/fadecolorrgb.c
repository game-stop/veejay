...
vj_effect *fadecolorrgb_init(int w,int h)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ...
        VJ_BEAT_KICK,     VJ_BEAT_F_CONTINUOUS,                       32,                 255,                14, 58, 90,   720,  0,   82,    /* Opacity */
        VJ_BEAT_KICK,     VJ_BEAT_F_CONTINUOUS,                       0,                  255,                14, 58, 90,   720,  0,   82,    /* Red */
        VJ_BEAT_SNARE,    VJ_BEAT_F_CONTINUOUS,                       0,                  255,                8,  36, 120,  900,  0,   66,    /* Green */
        VJ_BEAT_HAT,      VJ_BEAT_F_CONTINUOUS,                       0,                  255,                4,  26, 80,   620,  0,   50,    /* Blue */
