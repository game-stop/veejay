...
vj_effect *reflection_init(int width, int height)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ve->num_params,
        VJ_BEAT_DRIFT,    VJ_BEAT_F_PHRASE_ONLY | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_NO_ZERO_CROSS, 1,                  x_hi,               4,  14, 3000, 8200, 2200, 24,
        VJ_BEAT_DRIFT,    VJ_BEAT_F_PHRASE_ONLY | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_NO_ZERO_CROSS, 1,                  y_hi,               4,  14, 3000, 8200, 2200, 24,
