...
vj_effect *noisepencil_init(int width, int height)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ...
        VJ_BEAT_INTENSITY, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                    320,                2600,               16, 62,  700, 2800, 0,    86,
        VJ_BEAT_DETAIL,    VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_INVERTED | VJ_BEAT_F_NO_ZERO_CROSS, 16,                 104,                12, 46, 1000, 3600, 0,    62,
        VJ_BEAT_DETAIL,    VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                    128,                235,                12, 46, 1000, 3600, 0,    62
    );
