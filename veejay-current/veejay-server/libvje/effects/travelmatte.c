...
vj_effect *travelmatte_init(int w, int h)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ...
        VJ_BEAT_ALPHA_OR_OPACITY, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 650,                1450,              10, 38,  900, 3200, 0,    68,

        VJ_BEAT_SIGNED_CURVE,     VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL,        VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0,  0,    0,   0,    0,    -1000,

        VJ_BEAT_ALPHA_OR_OPACITY, VJ_BEAT_F_CONTINUOUS,                           0,                  128,               5,  18, 1600, 4800, 0,    28,

        VJ_BEAT_ALPHA_OR_OPACITY, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 80,                 760,               14, 56,  700, 2600, 0,    92
    );
