...
vj_effect *slice_init(int width, int height)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ve->num_params,
        VJ_BEAT_WARP,             VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS, 4,   112,  14, 54, 800,  3000, 0, 82,
        VJ_BEAT_SPEED,            VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_INVERTED,                              0,   180,  10, 38, 1200, 4200, 0, 58,
        ...
        VJ_BEAT_WARP,             VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS, 140, 1000, 16, 62, 700,  2800, 0, 92,
        VJ_BEAT_TRIGGER,          VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_IMPULSE | VJ_BEAT_F_REBUILDS_STATE,     120, 1000, 18, 72, 120,  900,  0, 88
    );
