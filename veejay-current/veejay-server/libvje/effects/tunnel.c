    ...
    int *outV)
{
    ...
    *outU = bilerp_i((int)srcU[i00] - 128, (int)srcU[i10] - 128, (int)srcU[i01] - 128, (int)srcU[i11] - 128, fx, fy);
    *outV = bilerp_i((int)srcV[i00] - 128, (int)srcV[i10] - 128, (int)srcV[i01] - 128, (int)srcV[i11] - 128, fx, fy);
}
...
static void tunnel_build_value_hints(vj_effect *ve)
{
    ...
    vje_build_value_hint_list(ve->hints, ve->limits[1][P_SHAPE], P_SHAPE, "Rectangle", "Circle", "Diamond", "Star", "Flower", "Flow Turbulence");
    vje_build_value_hint_list(ve->hints, ve->limits[1][P_HIGH_QUALITY], P_HIGH_QUALITY, "Fast", "High Quality");
}

static void tunnel_build_beat_hints(vj_effect *ve)
{
    const vj_beat_param_hint_t beat_hints[] = {
        VJ_BEAT_HINT_V2(VJ_BEAT_SIGNED_SPEED, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_SIGN_LOCK | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_SIGNED, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_SOURCE_SIGN, VJ_BEAT_CURVE_LINEAR, -70, 70, 98, 100, 0, 320, 0, 1, 0, VJ_BEAT_COST_CHEAP, 100, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        VJ_BEAT_HINT_V2(VJ_BEAT_WARP, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_LOW_ONSET, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 12, 92, 72, 100, 30, 620, 0, 1, 0, VJ_BEAT_COST_CHEAP, 90, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        VJ_BEAT_HINT_V2(VJ_BEAT_SPEED, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_MID_ONSET, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 4, 60, 62, 96, 40, 680, 0, 1, 0, VJ_BEAT_COST_CHEAP, 82, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        VJ_BEAT_HINT_V2(VJ_BEAT_SIGNED_CURVE, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_SIGN_LOCK | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_SIGNED, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_SOURCE_SIGN, VJ_BEAT_CURVE_LINEAR, -82, 82, 90, 100, 0, 360, 0, 1, 0, VJ_BEAT_COST_CHEAP, 94, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        ...
        VJ_BEAT_HINT_V2(VJ_BEAT_GEOMETRY_PHASE, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_WRAP, VJ_BEAT_SRC_SCRATCH_SIGNED, VJ_BEAT_OP_RATE, VJ_BEAT_POLARITY_SOURCE_SIGN, VJ_BEAT_CURVE_LINEAR, 0, 1000, 74, 98, 0, 320, 0, 2, 0, VJ_BEAT_COST_CHEAP, 78, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        VJ_BEAT_HINT_V2(VJ_BEAT_MEMORY, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_ENVELOPE, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LOG, 38, 88, 70, 96, 160, 1200, 0, 1, 0, VJ_BEAT_COST_CHEAP, 82, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        VJ_BEAT_HINT_V2(VJ_BEAT_SELECTOR, VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL, VJ_BEAT_SRC_NONE, VJ_BEAT_OP_NONE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LINEAR, VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0, 0, 0, 0, 0, 0, 0, VJ_BEAT_COST_STRUCTURAL, -1000, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        VJ_BEAT_HINT_V2(VJ_BEAT_SELECTOR, VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL, VJ_BEAT_SRC_NONE, VJ_BEAT_OP_NONE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LINEAR, VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0, 0, 0, 0, 0, 0, 0, VJ_BEAT_COST_STRUCTURAL, -1000, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        VJ_BEAT_HINT_V2(VJ_BEAT_SPEED, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_ACTIVITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 0, 1000, 96, 100, 8, 420, 0, 5, 0, VJ_BEAT_COST_CHEAP, 98, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        VJ_BEAT_HINT_V2(VJ_BEAT_WINDOW_RADIUS, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_VELOCITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 0, 1000, 94, 100, 8, 420, 0, 5, 0, VJ_BEAT_COST_CHEAP, 96, 0, 0, VJ_BEAT_GROUP_NONE, 0),
        VJ_BEAT_HINT_V2(VJ_BEAT_COLOR_AMOUNT, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_HIGH_ACTIVITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_SMOOTHSTEP, 80, 900, 70, 98, 100, 900, 0, 5, 0, VJ_BEAT_COST_CHEAP, 88, 0, 0, VJ_BEAT_GROUP_NONE, 0)
    };
...
vj_effect *tunnel_init(int width, int height)
{
    ...
    ve->param_description = vje_build_param_list(ve->num_params, "Speed", "Curve Int", "Curve Speed", "Swirl", "Zoom", "Offset", "Feedback", "Shape", "High Quality", "Travel Drive", "Zoom Drive", "Chroma Flow");
...
void tunnel_apply(void *ptr, VJFrame *frame, int *args)
{
    ...
    int feedback_eff;
    float raw_speed, base_vel, drive_dir, drive_vel, speed_target;
    float ci_target, curve_int, cs_input, cs_target, curve_spd;
    float swirl_target, swirl, swirl_sin, zoom_base, zoom_target, z_force, zoom_breathe, zoom;
    float po_target, phase_offset;
    int two_layers;
    int32_t fb_fp, inv_fb_fp, chroma_fb_fp, inv_chroma_fp;
    uint8_t *srcY, *srcU, *srcV;
    float timef, liss_x, liss_y, v_phase_time, swirl_time, layer_step, chroma_phase;
    int swirl_active, phase_active, layer_active, chroma_active, chroma_bias, chroma_limit;
    const float *warp_lut, *wave_lut;
    int wm1, hm1;

    double new_time;

    #pragma omp single copyprivate(new_time, feedback_eff, raw_speed, base_vel, drive_dir, drive_vel, speed_target, ci_target, curve_int, cs_input, cs_target, curve_spd, swirl_target, swirl, swirl_sin, zoom_base, zoom_target, z_force, zoom_breathe, zoom, po_target, phase_offset, two_layers, fb_fp, inv_fb_fp, chroma_fb_fp, inv_chroma_fp, timef, liss_x, liss_y, v_phase_time, swirl_time, layer_step, chroma_phase, swirl_active, phase_active, layer_active, chroma_active, chroma_bias, chroma_limit, wm1, hm1)
    {
        ...
        feedback_eff = tunnel_clampi((int)(t->feedback_state + 0.5f), 0, 100);

        raw_speed = (float)speed_arg * 0.01f;
        base_vel = ((float)speed_arg * 0.005f) + (raw_speed * raw_speed * raw_speed * 0.15f);
        drive_dir = (base_vel < 0.0f) ? -1.0f : 1.0f;
        drive_vel = drive_dir * t->travel_drive_state * 0.145f;
        speed_target = base_vel + drive_vel;
        t->vel_state += (speed_target - t->vel_state) * 0.135f;
        
        new_time = t->time + (double)t->vel_state;
        t->time = new_time;

        ci_target = tanhf((float)p1_arg * 0.015f) * 0.75f;
        ci_target += t->travel_drive_state * 0.125f * ((ci_target < 0.0f) ? -1.0f : 1.0f);
        t->acc_state += (ci_target - t->acc_state) * 0.070f;
        curve_int = t->acc_state;

        cs_input = (float)p2_arg * 0.01f;
        cs_target = 0.2f * cs_input * cs_input + 0.02f;
        cs_target += t->travel_drive_state * 0.032f;
        t->phase_vel += (cs_target - t->phase_vel) * 0.055f;
        curve_spd = t->phase_vel;

        swirl_target = tanhf((float)swirl_arg * 0.02f) * 1.2f;
        swirl_target += t->travel_drive_state * 0.115f * ((swirl_target < 0.0f) ? -1.0f : 1.0f);
        t->swirl_state += (swirl_target - t->swirl_state) * 0.135f;
        swirl = t->swirl_state;
        swirl_sin = swirl * 0.7f;

        zoom_base = ((float)zoom_arg * 0.01f) + 0.2f;
        if(!t->state_ready) {
            t->zoom_state = zoom_base;
            t->state_ready = 1;
        }
        zoom_target = zoom_base * (1.0f + t->zoom_drive_state * 0.110f);
        z_force = zoom_target - t->zoom_state;
        t->zoom_vel += z_force * 0.060f;
        t->zoom_vel *= 0.84f;
        t->zoom_state += t->zoom_vel;
        zoom_breathe = 1.0f + t->zoom_drive_state * 0.030f * FAST_SIN_T(t, t->drive_phase * 0.37f + (float)t->time * 0.63f);
        zoom = t->zoom_state * zoom_breathe;

        po_target = (float)offset_arg * 0.002f;
        po_target += t->travel_drive_state * 0.165f;
        t->phase += (po_target - t->phase) * 0.055f;
        phase_offset = t->phase;

        t->drive_phase += t->vel_state * 0.35f + t->travel_drive_state * 0.030f + t->zoom_drive_state * 0.012f;

        if(t->travel_drive_state > 0.001f) {
            int fb_drop = (int)(t->travel_drive_state * 8.0f + 0.5f);
            feedback_eff = tunnel_clampi(feedback_eff - fb_drop, 0, 96);
        }

        two_layers = high_quality;
        fb_fp = TO_FP((float)feedback_eff * 0.01f);
        inv_fb_fp = FP_ONE - fb_fp;
        chroma_fb_fp = (fb_fp * 3) >> 2;
        inv_chroma_fp = FP_ONE - chroma_fb_fp;

        timef = (float)t->time;
        liss_x = cosf(timef * curve_spd * 2.0f) * curve_int;
        liss_y = sinf(timef * curve_spd * 3.0f) * curve_int;
        v_phase_time = timef * 0.5f;
        swirl_time = timef * 0.8f;
        layer_step = phase_offset * 0.25f;
        chroma_phase = t->drive_phase + timef * 0.21f;

        swirl_active = (swirl > 0.00001f || swirl < -0.00001f);
        phase_active = (phase_offset > 0.00001f || phase_offset < -0.00001f);
        layer_active = two_layers && (layer_step > 0.00001f || layer_step < -0.00001f);
        chroma_active = t->chroma_flow_state > 0.0001f;
        chroma_bias = (int)(t->chroma_flow_state * (3.0f + t->travel_drive_state * 24.0f) + 0.5f);
        chroma_limit = 112 - (int)(t->travel_drive_state * 8.0f);
        if(chroma_limit < 96) chroma_limit = 96;
    ...
    srcU = frame->data[1];
    srcV = frame->data[2];
    warp_lut = (t->vel_state >= 0.0f) ? t->warp_pos_lut : t->warp_neg_lut;
    wave_lut = t->wave_lut;
    ...
    #pragma omp single
    {
        veejay_memcpy(frame->data[0], t->dstY, size);
        veejay_memcpy(frame->data[1], t->dstU, size);
        veejay_memcpy(frame->data[2], t->dstV, size);
    }
}