...
vj_effect *sinoids_init(int width, int height)
{
...

    {
        const vj_beat_param_hint_t beat_hints[] = {
            ...
            VJ_BEAT_HINT_V2(VJ_BEAT_DRIFT, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_WRAP, VJ_BEAT_SRC_SCRATCH_SIGNED, VJ_BEAT_OP_RATE, VJ_BEAT_POLARITY_SOURCE_SIGN, VJ_BEAT_CURVE_LINEAR, 1, 1000, 72, 100, 0, 240, 0, 1, 140, VJ_BEAT_COST_EXPENSIVE, 72, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_SPEED, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_SIGNED, VJ_BEAT_OP_OFFSET_BASE, VJ_BEAT_POLARITY_SOURCE_SIGN, VJ_BEAT_CURVE_EASE_OUT, 120, 880, 76, 100, 8, 520, 0, 1, 0, VJ_BEAT_COST_CHEAP, 88, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            ...
            VJ_BEAT_HINT_V2(VJ_BEAT_DRIFT, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_VELOCITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 0, 1000, 86, 100, 8, 420, 0, 5, 140, VJ_BEAT_COST_EXPENSIVE, 90, 0, 0, VJ_BEAT_GROUP_NONE, 0)
        };
...
#pragma omp single
    ...
    s->ns__ = ns;
    s->motion__ = motion;
    s->interpolate__ = interpolate;
    }

    mode = s->mode__;
    ns = s->ns__;
    motion = s->motion__;
    interpolate = s->interpolate__;
    ...
    uint8_t *dst[3] = {
        s->sinoid_frame[0], s->sinoid_frame[1], s->sinoid_frame[2]
    };
    const uint8_t *src[3] = {
