...
vj_effect *charcoalsketch_init(int w, int h)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ve->num_params,
        VJ_BEAT_WINDOW_RADIUS, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 3,   34,  10, 38, 1100, 3600, 0,    58,
        VJ_BEAT_CONTRAST,      VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, 112, 245, 14, 58,  800, 2800, 0,    82,
        VJ_BEAT_TURBULENCE,    VJ_BEAT_F_CONTINUOUS,                           0,   52,  10, 42,  900, 3000, 0,    66
    );
