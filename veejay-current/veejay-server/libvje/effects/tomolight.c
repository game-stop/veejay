...
vj_effect *tomolight_init(int w, int h)
{
    ...
    );
    {
        const vj_beat_param_hint_t beat_hints[] = {
            ...
            VJ_BEAT_HINT_V2(VJ_BEAT_ALPHA_OR_OPACITY, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_ACTIVITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 40, 100, 88, 100, 8, 420, 0, 1, 220, VJ_BEAT_COST_EXPENSIVE, 96, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_INTENSITY, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_HIGH_ONSET, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_PUNCH, 30, 100, 84, 100, 4, 440, 24, 1, 220, VJ_BEAT_COST_EXPENSIVE, 90, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_MEMORY, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_ENVELOPE, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_SMOOTHSTEP, 54, 96, 72, 96, 260, 1800, 0, 1, 0, VJ_BEAT_COST_CHEAP, 72, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_SELECTOR, VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL, VJ_BEAT_SRC_NONE, VJ_BEAT_OP_NONE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LINEAR, VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0, 0, 0, 0, 0, 0, 0, VJ_BEAT_COST_STRUCTURAL, -1000, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_GEOMETRY_AMPLITUDE, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_VELOCITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 70, 260, 84, 100, 10, 480, 0, 1, 160, VJ_BEAT_COST_MODERATE, 84, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_DETAIL, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_BURST, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_PUNCH, 8, 36, 84, 100, 6, 440, 24, 1, 260, VJ_BEAT_COST_MODERATE, 82, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_MOTION_REACT, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_WRAP | VJ_BEAT_F_REBUILDS_STATE, VJ_BEAT_SRC_SCRATCH_SIGNED, VJ_BEAT_OP_RATE, VJ_BEAT_POLARITY_SOURCE_SIGN, VJ_BEAT_CURVE_LINEAR, 0, 1000, 82, 100, 0, 240, 0, 2, 100, VJ_BEAT_COST_MODERATE, 92, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_WINDOW_RADIUS, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_REBUILDS_STATE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_BURST, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_PUNCH, 5, 45, 84, 100, 6, 440, 24, 1, 160, VJ_BEAT_COST_MODERATE, 80, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_SELECTOR, VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL, VJ_BEAT_SRC_NONE, VJ_BEAT_OP_NONE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LINEAR, VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0, 0, 0, 0, 0, 0, 0, VJ_BEAT_COST_STRUCTURAL, -1000, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_SELECTOR, VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL, VJ_BEAT_SRC_NONE, VJ_BEAT_OP_NONE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LINEAR, VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0, 0, 0, 0, 0, 0, 0, VJ_BEAT_COST_STRUCTURAL, -1000, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_RESET, VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL, VJ_BEAT_SRC_NONE, VJ_BEAT_OP_NONE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LINEAR, VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0, 0, 0, 0, 0, 0, 0, VJ_BEAT_COST_STRUCTURAL, -1000, 0, 0, VJ_BEAT_GROUP_NONE, 0)
        };
...
static void tl_seed(tomolight_t *t, VJFrame *frame)
{
    ...
    veejay_memcpy(t->prev_y, frame->data[0], len);
    veejay_memset(t->src_y, 0, len);
    veejay_memset(t->res_y, 0, len);
    veejay_memset(t->glow, 0, glen);
    veejay_memset(t->glow_tmp, 0, glen);
    veejay_memset(t->glow_next, 0, glen);
...
#pragma omp single
    {
        t->work_amount = clampi(tl_smooth_i(&t->eff_amount, amount_arg, 0.20f, 0.090f), 0, 100);
        t->work_light = clampi(tl_smooth_i(&t->eff_light, light_arg, 0.24f, 0.115f), 0, 100);
        t->work_residue = clampi(tl_smooth_i(&t->eff_residue, residue_arg, 0.120f, 0.060f), 0, 99);
        t->work_depth = clampi(tl_smooth_i(&t->eff_depth_scale, depth_arg, 0.145f, 0.070f), 0, 300);
        t->work_slices = clampi(tl_smooth_i(&t->eff_slices, slices_arg, 0.110f, 0.055f), 2, 64);
        t->work_scan_pos = tl_smooth_wrap1000_i(&t->eff_scan_pos, scan_pos_arg, 0.185f);
        t->work_scan_width = clampi(tl_smooth_i(&t->eff_scan_width, scan_width_arg, 0.180f, 0.080f), 1, 100);
    }
    const int amount_eff = t->work_amount;
    const int light_strength = t->work_light;
    const int residue_eff = t->work_residue;
    const int depth_eff = t->work_depth;
    const int slices = t->work_slices;
    const int scan_pos_eff = t->work_scan_pos;
    const int scan_width_eff = t->work_scan_width;
...
#pragma omp single
    ...
    const int depth_scale_q8 = (depth_eff * 256 + 50) / 100;
    const int motion_react_q8 = ((clampi(50 + (depth_eff / 5), 50, 110)) * 256 + 50) / 100;
...
#pragma omp single
        {
            ...
            veejay_memset(glow_next, 0, (size_t) t->glen);
