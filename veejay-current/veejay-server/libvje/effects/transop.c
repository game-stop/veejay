...
vj_effect *transop_init(int width, int height)
{
...

    {
        const vj_beat_param_hint_t beat_hints[] = {
            VJ_BEAT_HINT_V2(VJ_BEAT_WINDOW_RADIUS, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_VELOCITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 8, max_w, 80, 100, 12, 520, 0, 1, 80, VJ_BEAT_COST_MODERATE, 82, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_WINDOW_RADIUS, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_DISCRETE | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_VELOCITY, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_EASE_OUT, 8, max_h, 78, 100, 12, 520, 0, 1, 80, VJ_BEAT_COST_MODERATE, 80, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            ...
            VJ_BEAT_HINT_V2(VJ_BEAT_DRIFT, VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL, VJ_BEAT_SRC_NONE, VJ_BEAT_OP_NONE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_LINEAR, VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0, 0, 0, 0, 0, 0, 0, VJ_BEAT_COST_STRUCTURAL, -1000, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_DRIFT, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_BAND_BALANCE, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_SOURCE_SIGN, VJ_BEAT_CURVE_LINEAR, 0, max_h, 68, 92, 40, 520, 0, 2, 0, VJ_BEAT_COST_CHEAP, 64, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            VJ_BEAT_HINT_V2(VJ_BEAT_DRIFT, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_SIGNED, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_SOURCE_SIGN, VJ_BEAT_CURVE_LINEAR, 0, max_w, 86, 100, 0, 320, 0, 2, 0, VJ_BEAT_COST_CHEAP, 84, 0, 0, VJ_BEAT_GROUP_NONE, 0),
            ...
            VJ_BEAT_HINT_V2(VJ_BEAT_WINDOW_RADIUS, VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS, VJ_BEAT_SRC_SCRATCH_BURST, VJ_BEAT_OP_MAP_RANGE, VJ_BEAT_POLARITY_POSITIVE, VJ_BEAT_CURVE_PUNCH, 0, 1000, 90, 100, 6, 440, 24, 5, 0, VJ_BEAT_COST_CHEAP, 94, 0, 0, VJ_BEAT_GROUP_NONE, 0)
        };
                              ...
                              int dx)
{
    ...
    for(int y = 0; y < rect_h; y++) {
        ...
        memcpy(dY  + dst, sY  + src, rect_w);
        memcpy(dCb + dst, sCb + src, rect_w);
        memcpy(dCr + dst, sCr + src, rect_w);
    }
}
...
void transop_apply(void *ptr, VJFrame *frame, VJFrame *frame2, int *args)
{
    ...
    int rect_w = 0, rect_h = 0, sx = 0, sy = 0, dx = 0, dy = 0;
...
#pragma omp single
    {
        ...
        rect_w = transop_clampi(transop_round_to_i(t->rect_w + size_add_w * (0.35f + 0.65f * fabsf(s1))), 0, width);
        rect_h = transop_clampi(transop_round_to_i(t->rect_h + size_add_h * (0.35f + 0.65f * fabsf(c0))), 0, height);

        sx = transop_clampi(transop_round_to_i(t->src_x - slide_amp_x * s0 * 0.42f), 0, width);
        sy = transop_clampi(transop_round_to_i(t->src_y - slide_amp_y * c0 * 0.42f), 0, height);
        dx = transop_clampi(transop_round_to_i(t->dst_x + slide_amp_x * s0), 0, width);
        dy = transop_clampi(transop_round_to_i(t->dst_y + slide_amp_y * s1), 0, height);
