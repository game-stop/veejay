...
vj_effect *shutterdrag_init(int w, int h)
{
    ...
    ve->beat_hints = vje_build_beat_hint_list(
        ve->num_params,
        VJ_BEAT_MEMORY,    VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                     8,                  96,                 14, 54,  800, 3000, 0,    82,
        VJ_BEAT_MEMORY,    VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                     8,                  92,                 12, 46, 1000, 3600, 0,    70,
        VJ_BEAT_SELECTOR,  VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL,                            VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0,  0,    0,    0,    0,    -1000,
        VJ_BEAT_GLOW,      VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                     6,                  92,                 14, 54,  800, 3000, 0,    80,
        VJ_BEAT_CONTRAST,  VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                     92,                 245,                12, 46, 1000, 3600, 0,    72,
        VJ_BEAT_WARP,      VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                     12,                 92,                 12, 46, 1000, 3600, 0,    70,
        VJ_BEAT_CONTRAST,  VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_INVERTED | VJ_BEAT_F_NO_ZERO_CROSS, 96,                 420,                10, 38, 1200, 4200, 0,    54,
        VJ_BEAT_SELECTOR,  VJ_BEAT_F_REJECT | VJ_BEAT_F_STRUCTURAL,                            VJ_BEAT_SOFT_UNSET, VJ_BEAT_SOFT_UNSET, 0,  0,    0,    0,    0,    -1000,
        VJ_BEAT_MEMORY,    VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                     160,                1000,               16, 62,  700, 2800, 0,    92,
        VJ_BEAT_GLOW,      VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                     140,                1000,               16, 62,  700, 2800, 0,    90,
        VJ_BEAT_WARP,      VJ_BEAT_F_CONTINUOUS | VJ_BEAT_F_NO_ZERO_CROSS,                     120,                1000,               14, 54,  800, 3200, 0,    82
    );
