...
int		vj_tag_sprint_status(int tag_id, int tags,int cache,int sa, int ca, int r, int f, int m, int t,int seq_rec_id, int curfps, uint32_t lo, uint32_t hi, int macro,char *str );
