...
/* Compile optional NDI network video/audio support */
#define HAVE_NDI 1
...
#define HAVE_PTHREADSTACKSIZE /**/

/* Define to 1 if you have the `sched_get_priority_max' function. */
#define HAVE_SCHED_GET_PRIORITY_MAX 1

/* SDL2 library is installed */
#define HAVE_SDL 1
...
/* Name of package */
#define PACKAGE "reloaded"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "nwelburg@gmail.com"
...
/* Enable VIMS buffer validation in debug builds */
/* #undef VALIDATE_VIMS */
