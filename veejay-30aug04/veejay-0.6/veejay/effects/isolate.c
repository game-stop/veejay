...
void isolate_apply(uint8_t * src1[3], int width,
		   ...
		   int b, int opacity)
{
	...
	if (abs(yy) > val) {
		...
		src1[0][pos] = (op0 * src1[0][pos] + (op1 * 235)) / 255;
		src1[1][pos] = (op0 * src1[1][pos] + (op1 * 128)) / 255;
		src1[2][pos] = (op0 * src1[2][pos] + (op1 * 128)) / 255;
	}
    }
}
