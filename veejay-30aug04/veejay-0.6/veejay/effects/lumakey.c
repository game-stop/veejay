...
void lumakey_apply(uint8_t * yuv1[3], uint8_t * yuv2[3], int width,
		   ...
		   int feather, int d)
{
    ...
    case 0:
	/* normal overlay */
	lumakey_simple(yuv1, yuv2, width, height, threshold, threshold2,
		       feather);
	break;
    case 1:
	/* threshold */
	lumakey_smooth_white(yuv1, yuv2, width, height, threshold,
			     threshold2, feather, d);
	break;
    case 2:
	lumakey_smooth(yuv1, yuv2, width, height, threshold, threshold2,
		       feather, d);
	break;
    }
