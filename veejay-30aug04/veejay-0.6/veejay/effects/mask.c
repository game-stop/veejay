...
void simplemask_apply(uint8_t * yuv1[3], uint8_t * yuv2[3], int width,
		   int height, int threshold, int invert)
{
    ...
    switch(invert) {
     case 0 : mask_replace_black(yuv1,yuv2,width,height,threshold); break;
     case 1 : mask_replace_black_fill(yuv1,yuv2,width,height,threshold); break;
    }  
