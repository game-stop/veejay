...
void noisepencil_apply(uint8_t *src[3], int width, int height, int type, int coeef, int min_t,
	int max_t) {

	switch(type) {
		case 0:
		noisepencil_1_apply(src,width,height,coeef,min_t,max_t);	break;
		case 1:
		noisepencil_2_apply(src,width,height,coeef,min_t,max_t);	break;
		case 2:
		noisepencil_3_apply(src,width,height,coeef,min_t,max_t);	break;
		case 3:
		noisepencil_4_apply(src,width,height,coeef,min_t,max_t);	break;
	}
}
