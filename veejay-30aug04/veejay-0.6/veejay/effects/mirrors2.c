...
void mirrors2_apply(uint8_t * yuv[3], int width, int height, int type)
{
    switch (type) {
    case 0:
	mirror_multi_dr(yuv, width, height);
	break;
    case 1:
	mirror_multi_ur(yuv, width, height);
	break;
    case 2:
	mirror_multi_u(yuv, width, height);
	break;
    case 3:
	mirror_multi_d(yuv, width, height);
	break;
    case 4:
	mirror_multi_l(yuv, width, height);
	break;
    case 5:
	mirror_multi_r(yuv, width, height);
	break;
    }
}
void mirrors2_free(){}
