		     ...
		     int height, int type, int t1, int t2, int opacity)
{
    ...
    switch (type) {
    case 0:
	opacity_by_threshold(yuv, yuv2, width, height, t1, t2, opacity);
	break;
    case 1:
	opacity_by_threshold_(yuv, yuv2, width, height, t1, t2, opacity);
	break;
    case 2:
	opacity_by_threshold_blur(yuv, yuv2, width, height, t1, t2,
				  opacity);
	break;
