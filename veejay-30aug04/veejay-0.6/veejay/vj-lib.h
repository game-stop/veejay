...
typedef struct {
    ...
    vj_vlb *lb[4];		/* vloopback input */
    vj_vlb *lb_out;		/* vloopback output */
    vj_ffmpeg *decoder;		/* ffmpeg MJPEG decoder */
    vj_ffmpeg *encoder;		/* ffmpeg MJPEG encoder */
    vj_ffmpeg *mpeg4_encoder;
    vj_ffmpeg *mpeg4_decoder;
    vj_ffmpeg *divx_encoder;
    vj_ffmpeg *divx_decoder;
    vj_osc *osc;
    vj_frameinfo *fi;		/* frame functions, histogram  */
    vj_video_block *effect_data;	/* pointers to yuv 4:2:0 data */
    ...
    vj_window *windows[CLIP_MAX_EFFECTS];
    int real_fps;
    int dump;
    int verbose;
    int no_bezerk;
