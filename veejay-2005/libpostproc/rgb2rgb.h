 ...
 * problem for anyone then tell me, and ill fix it)
 */
extern void (*yv12toyuy2_)(const uint8_t *ysrc, const uint8_t *usrc, const uint8_t *vsrc, uint8_t *dst,
 ...
 * problem for anyone then tell me, and ill fix it)
 */
extern void (*yuy2toyv12_)(const uint8_t *src, uint8_t *ydst, uint8_t *udst, uint8_t *vdst,
	unsigned int width, unsigned int height,
