 ...
 *
 * 2003/03: nielselburg@yahoo.de 
 *	removed perror msg handling, added  
 *	v4lgetcolor, v4lgethue, v4lgetcontrast, v4lhastuner ...
 *
 * this class also handles reading from a vloopback device with
 * read() system call (mmap is yet to be done)
 */
