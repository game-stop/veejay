...
/* function Init
  ...
  this function receives a list of arguments to initialize your plugin's specific context.
  Your plugin's context must be set in void **ctxp
