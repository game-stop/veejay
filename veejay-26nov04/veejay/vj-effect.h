...
extern void dices_apply(vj_effect * data, VJFrame *frame, int width,
...
extern void diff_apply(vj_effect_data *dd, VJFrame *frame,
...
//extern void yuvchannelmix_apply(VJFrame *frame,VJFrame *frame2, int width, int height,
